    ...
    <div class="content-body">
        <div class="container p-0">
            <div class="d-flex align-items-center p-3">
                <h3 class="text-dark" style="margin-left: -20px;">Leave Section</h3>
            ...
            <div class="row mt-2 bg-white p-3 shadow-sm">
                <div class="table-responsive">
                    <div class="col d-flex justify-content-center">
                        <a href="add-leaveType.php" class="btn btn-primary">Add New Leave Type</a>
                    </div>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark small">Leave Type</th>
                                
                                <th class="table-dark small">Description</th>
                                
                                <th class="table-dark small">Created</th>
