    ...
    <div class="content-body">
        <div class="container p-0">
            <div class="d-flex align-items-center p-3">
                <h3 class="text-dark">Declined Leaves</h3>
            ...
            <div class="table-responsive mt-2 bg-white p-3 shadow-sm">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center" style="color: red;">Declined <i class="fa fa-xmark"></i> </td>
