...
<body>
    ...
    <div class="content-body">
        <div class="d-flex align-items-center p-3">
            <h3 class="text-dark" style="margin-left: -18px;">Department Section</h3>
        ...
        <div class="bg-light small p-4">
            <p class="text-muted mb-4">Please fill up the form in order to add new department</p>
            <?php 
            ...
            ?>
            <form action="../operations/add-department.php" class="m-0" method="POST">
                <label for="">Department Name</label>
                <input type="text" name="deptName" class="form-control mt-2 mb-3">

                <label for="">Shortform</label>
                <input type="text" name="deptShortform" class="form-control mt-2 mb-3">

                <label for="">Code</label>
                <input type="text" name="deptCode" class="form-control mt-2 mb-3">
